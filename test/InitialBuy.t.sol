...
contract InitialBuyTest is Test {
    ...
    function setUp() public {
        ...
        helper = new MemeHelper(deployer, address(router), address(weth));
    ...
    function testCreateTokenWith50PercentInitialBuy() public {
        ...
        uint256 k = params.virtualETHReserve * params.virtualTokenReserve;
        uint256 newTokenReserve = params.virtualTokenReserve - expectedTokens;
        uint256 newETHReserve = k / newTokenReserve;
        uint256 expectedBNB = newETHReserve - params.virtualETHReserve;
    ...
    function testRevertWhenInitialBuyExceeds99Point9Percent() public {
        ...
        vm.prank(creator);
        vm.expectRevert(IMemeCore.InvalidSaleParameters.selector);
    ...
    function testInsufficientPaymentForInitialBuy() public {
        ...
        vm.expectRevert(IMemeCore.InsufficientFee.selector);
    ...
    function _calculateExpectedAmounts(IMemeCore.CreateTokenParams memory params)
    internal
    pure
    returns (uint256 expectedTokens, uint256 expectedBNB)
    {
        ...
        uint256 newTokenReserve = params.virtualTokenReserve - expectedTokens;
        uint256 newETHReserve = k / newTokenReserve;
        expectedBNB = newETHReserve - params.virtualETHReserve;
    }
}