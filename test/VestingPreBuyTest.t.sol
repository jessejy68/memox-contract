...
contract VestingPreBuyTest is Test {
    ...
    function _createTokenWithParams(IMemeCore.CreateTokenParams memory params) internal returns (address) {
        ...
        uint256 totalPayment = core.creationFee() + initialETH + params.marginEth;
