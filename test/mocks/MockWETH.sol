...
/**
 * @title MockWETH
 * @dev A mock implementation of Wrapped ETH (WETH9) for testing purposes.
...
contract MockWETH is ERC20 {
    ...
    /**
     * @dev Constructor that initializes the token with the name "Wrapped BNB" and symbol "WETH".
     */
    constructor() ERC20("Wrapped BNB", "WETH") {
        // Optionally mint some initial tokens to the deployer for testing
        // _mint(msg.sender, 1000000 * 10**18);
    }

    /**
     * @dev Deposit ETH to mint WETH. Msg.value is the amount of ETH to deposit.
     *      Mints an equivalent amount of WETH to the sender.
     */
    ...
    /**
     * @dev Mint tokens arbitrarily for testing setups (e.g., giving users initial WETH balance).
